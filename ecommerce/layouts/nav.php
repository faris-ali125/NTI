    ...
    $result = $categoriesObject->all("id,name_en", "name_en,id");
                                        ...
                                        <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                            <ul class="mega-menu">
                                                <?php foreach ($categories as $category) {
                                                    ...
                                                    $subcategoriesResult = $subCategoryObject->getSubsByCats();
                                                ...
                                                ?>
                                                    <li>
                                                        <ul>
                                                            <li><a class="font-weight-bold h3 text-dark" href="shop.php?cat=<?= $category['id'] ?>"><?= $category['name_en'] ?></a></li>
